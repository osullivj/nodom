...
struct Static {
	...
	inline static const char* font_size_base_cs{"font_size_base"};
	inline static const char* title_font_cs{"title_font"};
	inline static const char* title_font_size_base_cs{"title_font_size_base"};
	inline static const char* body_font_cs{"body_font"};
	inline static const char* body_font_size_base_cs{"body_font_size_base"};
	inline static const char* button_font_cs{"button_font"};
	inline static const char* button_font_size_base_cs{"button_font_size_base"};
	inline static const char* year_month_font_cs{"year_month_font"};
	inline static const char* year_month_font_size_base_cs{"year_month_font_size_base"};
	inline static const char* day_date_font_cs{"day_date_font"};
	inline static const char* day_date_font_size_base_cs{"day_date_font_size_base"};
