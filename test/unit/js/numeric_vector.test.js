...
import { joinUint8Arrays, float64ToUint16, uint16ToFloat64 }
from './node_modules/apache-arrow/util/buffer.js';


const uint16ToFloat64Array = (b) => new Float64Array(new Uint16Array(b).map(x => uint16ToFloat64(x)));
/*
...
function randomBytes(n) {
    ...
    while (inx < 65536*2) uint16array[inx++] = Math.trunc(Math.random() * 65_536);
...
function testIntVector/*<T extends Int>*/(/*DataType: new () => T*/tipe, values/*?: Array<any>*/) {
...
function testFloatVector/*<T extends Float>*/(/*DataType: new () => T*/tipe, values/*?: Array<any>*/) {
...
function testAndValidateVector(vector/*: Vector<T>*/, typed/*: T['TArray']*/, values/*: any[] = [...typed]*/) {
