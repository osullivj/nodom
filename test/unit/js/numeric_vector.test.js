...
import {
  ...
  Uint64,
  DataType,
} from "./node_modules/apache-arrow/Arrow.dom.js"; // 'apache-arrow';
...
const testValuesBuffer = joinUint8Arrays(
  testValueBuffers.map((b) => new Uint8Array(b)),
)[0].buffer;
...
// TODO: restore BigInt tests as needed
...
describe(`FloatVector`, () => {
  describe(`makeVector infers the type from the input TypedArray`, () => {
    const u16s = valuesTyped(Uint16Array).map((x) =>
      float64ToUint16(uint16ToFloat64(x)),
    );
  ...
  describe(`Vector<Float16>`, () => {
    testFloatVector(
      Float16,
      valuesArray(Uint16Array).map((x) => uint16ToFloat64(x)),
    );
    describe(`vectorFromArray accepts regular Arrays to construct Vector<Float16>`, () => {
      ...
      test(`has correct byteLength`, () => {
        expect(vector.byteLength).toBe(vector.length * 2);
      });
    });
  });
  describe(`Vector<Float32>`, () => {
    ...
    describe(`vectorFromArray accepts regular Arrays to construct Vector<Float32>`, () => {
      ...
      test(`has correct byteLength`, () => {
        expect(vector.byteLength).toBe(vector.length * 4);
      });
    });
  });
  describe(`Vector<Float64>`, () => {
    ...
    describe(`vectorFromArray accepts regular Arrays to construct Vector<Float64>`, () => {
      ...
      test(`has correct byteLength`, () => {
        expect(vector.byteLength).toBe(vector.length * 8);
      });
    });
  });
});
...
describe(`IntVector`, () => {
  ...
  describe(`Vector<Int8>`, () => {
    ...
    describe(`vectorFromArray accepts regular Arrays to construct Vector<Int8>`, () => {
      ...
      test(`has correct byteLength`, () => {
        expect(vector.byteLength).toBe(vector.length);
      });
    });
  });
...
function testIntVector /*<T extends Int>*/(
  /*DataType: new () => T*/ tipe,
  values /*?: Array<any>*/,
) {
  const type = new /*DataType*/ tipe();
  ...
  const chunked = testValueBuffers
    .map((b) => new ArrayType(b))
    .map(
      (b) =>
        new Vector([
          makeData({
  ...
  const vectorBegin = Math.trunc(vector.length * 0.25);
  const vectorEnd = Math.trunc(vector.length * 0.75);
  ...
  for (const [chunksType, vector] of combos) {
    describe(chunksType, () => {
      ...
      describe(`base case no slicing`, () => {
        testAndValidateVector(vector, typed, jsArray);
      });
      // test slicing without args
      describe(`slicing without args`, () => {
        testAndValidateVector(vector.slice(), typed.slice(), jsArray.slice());
      });
      ...
      describe(`splicing out the middle half`, () => {
        testAndValidateVector(
          ...
          new ArrayType(
            [
              ...typed.slice(0, typedBegin),
              ...typed.slice(typedEnd),
            ] /* as any[]*/,
          ),
...
function testFloatVector /*<T extends Float>*/(
  /*DataType: new () => T*/ tipe,
  values /*?: Array<any>*/,
) {
  const type = new tipe /*DataType*/();
  const ArrayType = type.ArrayType;
  ...
  const begin = Math.trunc(vector.length * 0.25);
  const end = Math.trunc(vector.length * 0.75);
  const combos = [
    [`vector`, vector],
    [`chunked`, chunked],
  ]; /* as [string, Vector<T>][]*/
...
function testAndValidateVector(
  vector /*: Vector<T>*/,
  typed /*: T['TArray']*/,
  values /*: any[] = [...typed]*/,
) {
...
function gets_expected_values /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  typed /*: T['TArray']*/,
  values /*: any[] = [...typed]*/,
) {
...
function iterates_expected_values /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  typed /*: T['TArray']*/,
  values /*: any[] = [...typed]*/,
) {
...
function indexof_returns_expected_values /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  typed /*: T['TArray']*/,
  values /*: any = [...typed]*/,
) {
...
function slice_returns_a_typedarray /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
) {
...
function slices_the_entire_array /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  values /*: T['TArray']*/,
) {
...
function slices_from_minus_20_to_length /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  values /*: T['TArray']*/,
) {
...
function slices_from_0_to_minus_20 /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  values /*: T['TArray']*/,
) {
...
function slices_the_array_from_0_to_length_minus_20 /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  values /*: T['TArray']*/,
) {
...
function slices_the_array_from_0_to_length_plus_20 /*<T extends Int | Float>*/(
  vector /*: Vector<T>*/,
  values /*: T['TArray']*/,
) {
  test(`slices the array from 0 to length + 20`, () => {
    expect.hasAssertions();
    expect(vector.slice(0, vector.length + 20).toArray()).toEqual(
      values.slice(0, values.length + 20),
    );
  });
}
